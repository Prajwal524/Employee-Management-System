...
<body class="min-h-screen grid-bg flex items-center justify-center px-4 bg-slate-50">
    ...
    <div class="card relative z-10 bg-white rounded-2xl shadow-xl border border-slate-100 p-10 w-full max-w-md">
        ...
        <h1 class="text-2xl font-extrabold text-slate-800 mb-1 tracking-tight">Welcome back</h1>
        ...
        <form action="login" method="POST" class="space-y-5">
            <div>
                <label class="block text-xs font-600 text-slate-500 uppercase tracking-wider mb-2">Email Address</label>
                <input class="input-field" type="email" name="mail" placeholder="you@company.com" required>
            </div>
            <div>
                <label class="block text-xs font-600 text-slate-500 uppercase tracking-wider mb-2">Password</label>
            ...
            <div class="flex items-center justify-between text-sm">
                ...
                <a href="forgot.jsp" class="text-indigo-600 font-semibold hover:text-indigo-800 transition-colors">Forgot password?</a>
            </div>
            <button type="submit" class="btn-primary mt-2">Sign In</button>
        </form>

        <p class="text-center text-slate-500 text-sm mt-7">
            Don't have an account? <a href="register.jsp" class="text-indigo-600 font-semibold hover:underline">Create one</a>
        </p>
    </div>
</body>
</html>
